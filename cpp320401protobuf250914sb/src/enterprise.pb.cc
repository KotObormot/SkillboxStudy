...
PROTOBUF_CONSTEXPR Enterprise::Enterprise(
  ...
  , /*decltype(_impl_.has_foreign_activity_)*/false} {}
struct EnterpriseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR EnterpriseDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 EnterpriseDefaultTypeInternal _Enterprise_default_instance_;
static ::_pb::Metadata file_level_metadata_enterprise_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_enterprise_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_enterprise_2eproto = nullptr;

const uint32_t TableStruct_enterprise_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Enterprise, _impl_.has_foreign_activity_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_enterprise_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020enterprise.proto\"\206\001\n\nEnterprise\022\027\n\017fou"
  "ndation_year\030\001 \002(\005\022\025\n\rlegal_address\030\002 \002("
  "\t\022\014\n\004name\030\003 \002(\t\022\025\n\ractivity_type\030\004 \001(\t\022#"
  "\n\024has_foreign_activity\030\005 \001(\010:\005false"
  ;
static ::_pbi::once_flag descriptor_table_enterprise_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_enterprise_2eproto = {
    false, false, 155, descriptor_table_protodef_enterprise_2eproto,
    "enterprise.proto",
    &descriptor_table_enterprise_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_enterprise_2eproto::offsets,
    file_level_metadata_enterprise_2eproto, file_level_enum_descriptors_enterprise_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_enterprise_2eproto(&descriptor_table_enterprise_2eproto);
...
class Enterprise::_Internal {
 public:
  ...
  static void set_has_has_foreign_activity(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
...
Enterprise::Enterprise(const Enterprise& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.has_foreign_activity_){}};
  ...
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_activity_type()) {
    _this->_impl_.activity_type_.Set(from._internal_activity_type(), 
      _this->GetArenaForAllocation());
  }
  ::memcpy(&_impl_.foundation_year_, &from._impl_.foundation_year_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.has_foreign_activity_) -
    reinterpret_cast<char*>(&_impl_.foundation_year_)) + sizeof(_impl_.has_foreign_activity_));
  // @@protoc_insertion_point(copy_constructor:Enterprise)
}

inline void Enterprise::SharedCtor(
...
// @@protoc_insertion_point(message_clear_start:Enterprise)
  ...
  if (cached_has_bits & 0x00000018u) {
    ::memset(&_impl_.foundation_year_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.has_foreign_activity_) -
        reinterpret_cast<char*>(&_impl_.foundation_year_)) + sizeof(_impl_.has_foreign_activity_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          goto handle_unusual;
        continue;
      // optional bool has_foreign_activity = 5 [default = false];
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_has_foreign_activity(&has_bits);
          _impl_.has_foreign_activity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Enterprise::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    ...
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_activity_type(), target);
  }

  // optional bool has_foreign_activity = 5 [default = false];
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_has_foreign_activity(), target);
  }
...
void Enterprise::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (cached_has_bits & 0x0000001fu) {
    ...
    if (cached_has_bits & 0x00000010u) {
      _this->_impl_.has_foreign_activity_ = from._impl_.has_foreign_activity_;
    }
...
void Enterprise::InternalSwap(Enterprise* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Enterprise, _impl_.has_foreign_activity_)
      + sizeof(Enterprise::_impl_.has_foreign_activity_)
      - PROTOBUF_FIELD_OFFSET(Enterprise, _impl_.foundation_year_)>(
