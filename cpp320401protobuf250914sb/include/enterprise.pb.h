...
PROTOBUF_NAMESPACE_OPEN
template<> ::Enterprise* Arena::CreateMaybeMessage<::Enterprise>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Enterprise final :
 ...
 public:
  ...
  enum : int {
    ...
    kHasForeignActivityFieldNumber = 5,
  };
  ...
  private:
  bool _internal_has_activity_type() const;
  public:
  ...
  bool has_has_foreign_activity() const;
  private:
  bool _internal_has_has_foreign_activity() const;
  public:
  void clear_has_foreign_activity();
  bool has_foreign_activity() const;
  void set_has_foreign_activity(bool value);
  private:
  bool _internal_has_foreign_activity() const;
  void _internal_set_has_foreign_activity(bool value);
  public:
...
// required int32 foundation_year = 1;
inline bool Enterprise::_internal_has_foundation_year() const {
...
// required string legal_address = 2;
inline bool Enterprise::_internal_has_legal_address() const {
...
void Enterprise::set_legal_address(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000001u;
...
inline void Enterprise::set_allocated_legal_address(std::string* legal_address) {
...
// required string name = 3;
inline bool Enterprise::_internal_has_name() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Enterprise::set_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
...
inline void Enterprise::set_allocated_name(std::string* name) {
  if (name != nullptr) {
    _impl_._has_bits_[0] |= 0x00000002u;
  } else {
    _impl_._has_bits_[0] &= ~0x00000002u;
...
// optional string activity_type = 4;
inline bool Enterprise::_internal_has_activity_type() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool Enterprise::has_activity_type() const {
  return _internal_has_activity_type();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Enterprise::set_activity_type(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000004u;
...
inline std::string* Enterprise::release_activity_type() {
  ...
  if (!_internal_has_activity_type()) {
    return nullptr;
  }
  _impl_._has_bits_[0] &= ~0x00000004u;
  auto* p = _impl_.activity_type_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void Enterprise::set_allocated_activity_type(std::string* activity_type) {
...
// optional bool has_foreign_activity = 5 [default = false];
inline bool Enterprise::_internal_has_has_foreign_activity() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Enterprise::has_has_foreign_activity() const {
  return _internal_has_has_foreign_activity();
}
inline void Enterprise::clear_has_foreign_activity() {
  _impl_.has_foreign_activity_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Enterprise::_internal_has_foreign_activity() const {
  return _impl_.has_foreign_activity_;
}
inline bool Enterprise::has_foreign_activity() const {
  // @@protoc_insertion_point(field_get:Enterprise.has_foreign_activity)
  return _internal_has_foreign_activity();
}
inline void Enterprise::_internal_set_has_foreign_activity(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.has_foreign_activity_ = value;
}
inline void Enterprise::set_has_foreign_activity(bool value) {
  _internal_set_has_foreign_activity(value);
  // @@protoc_insertion_point(field_set:Enterprise.has_foreign_activity)
}
